...
*********************************************************************************************/
    ...
    float determinant_test(float a[8][8], float k)
         ...
         for (c = 0; c < k; c++)

           {
            ...
            for (i = 0;i < k; i++)
              ...
              det = det + s * (a[0][c] * determinant_test(b, k - 1));
    ...
    void cofactor(float num[8][8], float f)
       ...
       for (p = 0;p < f; p++)

        {
...

         {
          ...
          fac[q][p] = pow(-1, q + p) * determinant_test(b, f - 1);
    ...
    void transpose(float num[8][8], float fac[8][8], float r)

    {

      int i, j;

      float b[8][8], inverse[8][8], d;
